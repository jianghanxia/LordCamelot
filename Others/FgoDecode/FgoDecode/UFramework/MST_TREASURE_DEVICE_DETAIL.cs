...
{
	public sealed class MST_TREASURE_DEVICE_DETAIL : IMessage, IMessage<MST_TREASURE_DEVICE_DETAIL>, IEquatable<MST_TREASURE_DEVICE_DETAIL>, IDeepCloneable<MST_TREASURE_DEVICE_DETAIL>
	{
		...
		private static readonly MessageParser<MST_TREASURE_DEVICE_DETAIL> _parser = new MessageParser<MST_TREASURE_DEVICE_DETAIL>(() => new MST_TREASURE_DEVICE_DETAIL());
		...
		[DebuggerNonUserCode]
		MessageDescriptor IMessage.Descriptor => MST_TREASURE_DEVICE_DETAIL.Descriptor;

		[DebuggerNonUserCode]
		public static MessageParser<MST_TREASURE_DEVICE_DETAIL> Parser => MST_TREASURE_DEVICE_DETAIL._parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => MstTreasureDeviceDetailReflection.Descriptor.MessageTypes[0];
		...
		[DebuggerNonUserCode]
		public MST_TREASURE_DEVICE_DETAIL()
		{
		}

		[DebuggerNonUserCode]
		public MST_TREASURE_DEVICE_DETAIL(MST_TREASURE_DEVICE_DETAIL other) : this()
		{
			this.id_ = other.id_;
		...
		[DebuggerNonUserCode]
		public MST_TREASURE_DEVICE_DETAIL Clone()
		{
			return new MST_TREASURE_DEVICE_DETAIL(this);
		}

		[DebuggerNonUserCode]
		public override bool Equals(object other)
		{
			return this.Equals(other as MST_TREASURE_DEVICE_DETAIL);
		}

		[DebuggerNonUserCode]
		public bool Equals(MST_TREASURE_DEVICE_DETAIL other)
		{
		...
		[DebuggerNonUserCode]
		public void MergeFrom(MST_TREASURE_DEVICE_DETAIL other)
		{
			if (other == null)
			{
				return;
