...
{
	public sealed class MST_COMBINE_QP : IMessage, IMessage<MST_COMBINE_QP>, IEquatable<MST_COMBINE_QP>, IDeepCloneable<MST_COMBINE_QP>
	{
		...
		private static readonly MessageParser<MST_COMBINE_QP> _parser = new MessageParser<MST_COMBINE_QP>(() => new MST_COMBINE_QP());
		...
		[DebuggerNonUserCode]
		MessageDescriptor IMessage.Descriptor => MST_COMBINE_QP.Descriptor;

		[DebuggerNonUserCode]
		public static MessageParser<MST_COMBINE_QP> Parser => MST_COMBINE_QP._parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => MstCombineQpReflection.Descriptor.MessageTypes[0];
		...
		[DebuggerNonUserCode]
		public MST_COMBINE_QP()
		{
		}

		[DebuggerNonUserCode]
		public MST_COMBINE_QP(MST_COMBINE_QP other) : this()
		{
		...
		[DebuggerNonUserCode]
		public MST_COMBINE_QP Clone()
		{
			return new MST_COMBINE_QP(this);
		}

		[DebuggerNonUserCode]
		public override bool Equals(object other)
		{
			return this.Equals(other as MST_COMBINE_QP);
		}

		[DebuggerNonUserCode]
		public bool Equals(MST_COMBINE_QP other)
		{
		...
		[DebuggerNonUserCode]
		public void MergeFrom(MST_COMBINE_QP other)
		{
			if (other == null)
			{
				return;
